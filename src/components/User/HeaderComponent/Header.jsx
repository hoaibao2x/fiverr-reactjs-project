              ...
              <nav className="navbar  navbar-expand-lg navbar-light">
                ...
                <div className="collapse navbar-collapse" id="navbarTogglerDemo01">
                  ...
                  <div className="search">
                    <input className="form-control" type="search" placeholder="What service are you looking for today?" aria-label="Search" />
                    <button className="btn btn-secondary btnicon" type="submit">
              ...
              <nav className="navbar navbar-expand-lg navbar-light">
                <div className="collapse navbar-collapse" id="navbarSupportedContent">
                  <ul className="navbar-nav mr-auto">
                    ...
                    <li className="nav-item">
                      <a className="nav-link btn btn-outline-success" href="#"><span className='btnicon2'>Join</span>
                      </a>
                    </li>
                  </ul>
                </div>
