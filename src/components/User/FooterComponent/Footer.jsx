...
export default function Footer(props) {
  return (
      <footer className='site-footer'>
        <div className='footer-warpper container'>
          <div className='footer-collapsibles'>
            <div className='footer-items'>
              <article className='footer-content'>
                <div className='footer-title'>
                  <div className='footer-title-text' data-toggle="collapse" href="#collapseCategories">
                    <h5>Categories</h5> 
                    <span className="icon-menu-footer"><span role="img" aria-label="down" class="anticon anticon-down"><svg viewBox="64 64 896 896" focusable="false" data-icon="down" width="1em" height="1em" fill="currentColor" aria-hidden="true"><path d="M884 256h-75c-5.1 0-9.9 2.5-12.9 6.6L512 654.2 227.9 262.6c-3-4.1-7.8-6.6-12.9-6.6h-75c-6.5 0-10.3 7.4-6.5 12.7l352.6 486.1c12.8 17.6 39 17.6 51.7 0l352.6-486.1c3.9-5.3.1-12.7-6.4-12.7z"></path></svg></span></span>
                  </div>
                </div>
                <div className='footer-collapsibles-content'>
            ...
            <div className='footer-items'>
              <article className='footer-content'>
                <div className='footer-title'>
                  <div className='footer-title-text' data-toggle="collapse" href="#collapseAbout">
                    <h5>About</h5> <span className="icon-menu-footer"> <span role="img" aria-label="down" class="anticon anticon-down"><svg viewBox="64 64 896 896" focusable="false" data-icon="down" width="1em" height="1em" fill="currentColor" aria-hidden="true"><path d="M884 256h-75c-5.1 0-9.9 2.5-12.9 6.6L512 654.2 227.9 262.6c-3-4.1-7.8-6.6-12.9-6.6h-75c-6.5 0-10.3 7.4-6.5 12.7l352.6 486.1c12.8 17.6 39 17.6 51.7 0l352.6-486.1c3.9-5.3.1-12.7-6.4-12.7z"></path></svg></span></span>
                  </div>
                </div>
                <div className='footer-collapsibles-content'>
                  <ul className="collapse" id="collapseAbout">
                    <li>
                      <a href="#">Careers</a>
                    </li>
                    <li>
            ...
            <div className='footer-items'>
              <article className='footer-content'>
                <div className='footer-title'>
                  <div className='footer-title-text' data-toggle="collapse" href="#collapseSupport">
                    <h5>Support</h5> <span className='icon-menu-footer'> <span role="img" aria-label="down" class="anticon anticon-down"><svg viewBox="64 64 896 896" focusable="false" data-icon="down" width="1em" height="1em" fill="currentColor" aria-hidden="true"><path d="M884 256h-75c-5.1 0-9.9 2.5-12.9 6.6L512 654.2 227.9 262.6c-3-4.1-7.8-6.6-12.9-6.6h-75c-6.5 0-10.3 7.4-6.5 12.7l352.6 486.1c12.8 17.6 39 17.6 51.7 0l352.6-486.1c3.9-5.3.1-12.7-6.4-12.7z"></path></svg></span></span>
                  </div>
                </div>
                <div className='footer-collapsibles-content'>
                  <ul className='collapse' id='collapseSupport'>
                    <li>
            ...
            <div className='footer-items'>
              <article className='footer-content'>
                <div className='footer-title'>
                  <div className='footer-title-text' data-toggle="collapse" href="#collapseCommunity">
                    <h5 >Community</h5>
                    <span className='icon-menu-footer'> <span role="img" aria-label="down" class="anticon anticon-down"><svg viewBox="64 64 896 896" focusable="false" data-icon="down" width="1em" height="1em" fill="currentColor" aria-hidden="true"><path d="M884 256h-75c-5.1 0-9.9 2.5-12.9 6.6L512 654.2 227.9 262.6c-3-4.1-7.8-6.6-12.9-6.6h-75c-6.5 0-10.3 7.4-6.5 12.7l352.6 486.1c12.8 17.6 39 17.6 51.7 0l352.6-486.1c3.9-5.3.1-12.7-6.4-12.7z"></path></svg></span></span>
                  </div>
                </div>
                <div className='footer-collapsibles-content'>
                  <ul className='collapse' id='collapseCommunity'>
                    <li>
                      <a href="#">Events</a>
                    </li>
                    <li>
            ...
            <div className='footer-items'>
              <article className='footer-content'>
                <div className='footer-title'>
                  <div className='footer-title-text' data-toggle="collapse" href="#collapseFiverr">
                    <h5 >More From Fiverr</h5>
                    <span className='icon-menu-footer'> <span role="img" aria-label="down" class="anticon anticon-down"><svg viewBox="64 64 896 896" focusable="false" data-icon="down" width="1em" height="1em" fill="currentColor" aria-hidden="true"><path d="M884 256h-75c-5.1 0-9.9 2.5-12.9 6.6L512 654.2 227.9 262.6c-3-4.1-7.8-6.6-12.9-6.6h-75c-6.5 0-10.3 7.4-6.5 12.7l352.6 486.1c12.8 17.6 39 17.6 51.7 0l352.6-486.1c3.9-5.3.1-12.7-6.4-12.7z"></path></svg></span></span>
                  </div>
                </div>
                <div className='footer-collapsibles-content'>
                  <ul className='collapse' id='collapseFiverr'>
                    <li>
          ...
          <div className='footer-bottom'>
            <div className='left'>
              <span className='fiverr-logo-footer'>
                <svg width="89" height="27" viewBox="0 0 91 27" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <g fill="#7A7D85">
              ...
              <p className='text-body-left'>
                <span className='text-coppy-right'>
            ...
            <div className='right'>
              <ul className='right-icon'>
                ...
                <li>
                  <a href="#"><i className="fa-brands fa-invision" /></a>
                </li>
                <li>
              ...
              <section className='section-right'>
                <button className='button-right'>
                  <span className="XQskgrQ trigger-icon" style={{ width: 16, height: 16 }} aria-hidden="true">
                ...
                <button className='button-right'>
                  <span className='label'>US$ USD</span>
                </button>
                <button className="button-right">
